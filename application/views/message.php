		...
		<div class="row">
			<div class="col-xs-12 text-right">
				<div class="form-group">
					<a class="btn btn-primary" href="<?php echo base_url(); ?>news/addNewMessage"><i class="fa fa-plus"></i> 新增</a>
				</div>
			</div>
		</div>
		<div class="row">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-sm btn-info" href="<?php echo base_url() . 'news/messageOld/' . $record->mesid; ?>" title="編輯"><i class="fa fa-pencil"></i></a>
									<a class="btn btn-sm btn-danger deleteMessage" href="#" data-mesid="<?php echo $record->mesid; ?>" title="移除"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							<?php
								}
