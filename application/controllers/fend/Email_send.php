...
class Email_send extends CI_Controller
{
    ...
    {
        $this->load->view('fend/email_send');
    }
    ...
    public function send()
    {
        ...
        $from = 'coolcariskao@gmail.com'; // Pass here your mail id
        ...
        $config['smtp_user'] = 'coolcariskao@gmail.com'; //Important
        $config['smtp_pass'] = '1jGxL5GvHulH2RDugIgF'; //Important
        ...
        // $this->email->attach('assets/uploads/jquery-upload-file/再生能源.jpg');
        ...
        return redirect('fend/email_send');
    }
}
